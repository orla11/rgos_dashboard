      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <logo class="w-12 mr-4 fill-current text-primary" style="margin-bottom: 0.3rem; margin-left: -0.8rem;" />
            <span class="vx-logo-text text-primary" v-show="isMouseEnter || !reduce">
              <img src="../../../assets/images/logo/rgos.png" alt="rgos_logo" class="w-24"/>
            </span>
          </router-link>
          <!-- /Logo -->
